...
<head>
    ...
    <title>Agri-Chain — Sign in</title>
...
<body>
    ...
    <main class="login-page">
        <div class="login-container">
            ...
            <p class="sr-only" id="securityNote">Never share your password. For your safety, make sure the site address starts with https://</p>
        </div>
    </main>
